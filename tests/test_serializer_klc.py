...
def test_ansi_keymap():
    ...
    assert keymap == split(
        ...
        1a	OEM_4	0	005b	007b	-1	-1	// [ {
        1b	OEM_6	0	005d	007d	-1	-1	// ] }
        28	OEM_7	0	0027	0022	-1	-1	// ' "
        29	OEM_3	0	0060	007e	-1	-1	// ` ~
...
def test_prog_keymap():
    ...
    assert keymap == split(
        ...
        1a	OEM_4	0	005b	007b	-1	-1	-1	-1	// [ {
        1b	OEM_6	0	005d	007d	-1	-1	-1	-1	// ] }
        28	OEM_7	0	0027	0022	-1	-1	0027@	0022@	// ' " ' "
        29	OEM_3	0	0060	007e	-1	-1	0060@	007e@	// ` ~ ` ~
