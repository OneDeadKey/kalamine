...
def test_prog():
    ...
    assert keymap == split(
        ...
        +SC10::SendKey("U+0051", {}) ; Q
         ...
         SC11::SendKey("U+0077", {"*``": "U+1e81", "*^": "U+0175", "*´": "U+1e83", "*¨": "U+1e85"}) ; w
        +SC11::SendKey("U+0057", {"*``": "U+1e80", "*^": "U+0174", "*´": "U+1e82", "*¨": "U+1e84"}) ; W
        ...
        +SC14::SendKey("U+0054", {}) ; T
         ...
         SC15::SendKey("U+0079", {"*``": "U+1ef3", "*~": "U+1ef9", "*^": "U+0177", "*´": "U+00fd", "*¨": "U+00ff"}) ; y
        +SC15::SendKey("U+0059", {"*``": "U+1ef2", "*~": "U+1ef8", "*^": "U+0176", "*´": "U+00dd", "*¨": "U+0178"}) ; Y
        ...
        +SC1e::SendKey("U+0041", {"*``": "U+00c0", "*~": "U+00c3", "*^": "U+00c2", "*´": "U+00c1", "*¨": "U+00c4"}) ; A
         ...
         SC1f::SendKey("U+0073", {"*^": "U+015d", "*´": "U+015b"}) ; s
        +SC1f::SendKey("U+0053", {"*^": "U+015c", "*´": "U+015a"}) ; S
        ...
        +SC21::SendKey("U+0046", {}) ; F
         ...
         SC22::SendKey("U+0067", {"*^": "U+011d", "*´": "U+01f5"}) ; g
        +SC22::SendKey("U+0047", {"*^": "U+011c", "*´": "U+01f4"}) ; G
        ...
        ;  Letters, third row
         ...
         SC2c::SendKey("U+007a", {"*^": "U+1e91", "*´": "U+017a"}) ; z
        +SC2c::SendKey("U+005a", {"*^": "U+1e90", "*´": "U+0179"}) ; Z

         SC2d::SendKey("U+0078", {"*¨": "U+1e8d"}) ; x
        +SC2d::SendKey("U+0058", {"*¨": "U+1e8c"}) ; X

         SC2e::SendKey("U+0063", {"*^": "U+0109", "*´": "U+0107"}) ; c
        +SC2e::SendKey("U+0043", {"*^": "U+0108", "*´": "U+0106"}) ; C
        ...
        +SC30::SendKey("U+0042", {}) ; B
         ...
         SC31::SendKey("U+006e", {"*``": "U+01f9", "*~": "U+00f1", "*´": "U+0144"}) ; n
        +SC31::SendKey("U+004e", {"*``": "U+01f8", "*~": "U+00d1", "*´": "U+0143"}) ; N
    ...
    assert altgr == split(
        ...
        ;  Letters, first row
         ...
         <^>!SC10::SendKey("U+003d", {"*~": "U+2243", "*^": "U+207c"}) ; =
